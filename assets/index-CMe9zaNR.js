(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const t of s)if(t.type==="childList")for(const a of t.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function d(s){const t={};return s.integrity&&(t.integrity=s.integrity),s.referrerPolicy&&(t.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?t.credentials="include":s.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function o(s){if(s.ep)return;s.ep=!0;const t=d(s);fetch(s.href,t)}})();async function y(){return await(await fetch("https://63ee0ec0388920150dd83e3c.mockapi.io/teams")).json()}function b(n){return{home:n.map(e=>({...e,points:Math.floor(e.points*.6)})),away:n.map(e=>({...e,points:Math.floor(e.points*.4)}))}}let p={general:!1,home:!1,away:!1};const f=async(n,e)=>{const d=await y();let o={};n==="home"||n==="away"?b(d)[n].forEach(c=>{o[c.group]||(o[c.group]=[]),o[c.group].push(c)}):d.forEach(a=>{o[a.group]||(o[a.group]=[]),o[a.group].push(a)}),e.innerHTML="";const s=['<span class="header-full">Игры</span><span class="header-short">И</span>','<span class="header-full">В</span><span class="header-short">В</span>','<span class="header-full">Н</span><span class="header-short">Н</span>','<span class="header-full">П</span><span class="header-short">П</span>','<span class="header-full">З-П</span><span class="header-short">З-П</span>','<span class="header-full">Форма</span>','<span class="header-full">Очки</span><span class="header-short">О</span>'],t={W:`<svg class="icon-td">
          ...
          </svg>`};Object.entries(o).forEach(([a,i])=>{i.sort((r,l)=>l.points-r.points);const c=document.createElement("table");c.classList.add("group-table",`group-${a}`);const h=`<thead>
    <tr class="head-tabl">
